...
# Astrid set working directory in console
# setwd("~/Documents/Zurich_PhD/courses/2021_01_11_Compulsory_LSZGS SysBio_Computational Biology/git_folder/AFModulus_Flex/") # I put AFModulus_Flex because the R file will start from here ... 

# Astrid, set your wd in console and leave the soft link on line 25, that way we can work on the same script. 
PATH = paste(getwd())
