%Procedure:     Uncertainty propagation for Young's Modulus
%Method:        Analytic uncertainty propagation (AUP): first order Taylor (analytic)
%Author:        Audrey Yeo {audreytyeo [at] gmail [dot] com}
%Last update:   21/10/2021 one day post USA's first female VP (KAMALAMAMA)
%Toolbox:       none

%NB:            This code is adapted from https://evelynegroen.github.io/Code/Uncertaintypropagation.html which is based on  Heijungs and Suh (2002); http://dx.doi.org/10.1007/978-94-015-9900-9
