...
```{r parabula, echo=F, warning=F, message = FALSE}
# Audrey
...
cols <- matrix(257 - seq_len(ncol(df)), byrow = T, ncol = ncol(df), nrow = nrow(df)) # "257 - " because image top and bottom need to be flipped
